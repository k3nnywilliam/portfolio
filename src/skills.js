        ...
        <Fragment>
            ...
            <hr/><br/><br/> 
                ...
                <div className="content2">
                    ...
                    <br/>
                    <h3>Programming</h3>
                    <p>Python, Javascript, C#, SQL, Bash, C++</p>
                    ...
                    <p>HTML5, CSS, Sass, React, Node, Express, Vue, Flask</p>
                    <h3>Cloud platforms/tools</h3>
                    <p>AWS, Docker, Terraform, Heroku, Digital Ocean, Netlify, Vercel</p>
                    <h3>CI/CD</h3>
                    <p>CircleCI, Travis CI, GitHub Actions</p>
                </div>
            </Container>
        </Fragment>
    ];
